  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="relative w-[390px] rounded-[2rem]  border-white/20 bg-transparent px-8 py-10"
      >
        ...
        <p className="text-white text-center font-jetbrains text-sm mb-10 [text-shadow:0_2px_10px_rgba(0,0,0,0.75)]">
          Continue your visual coding journey
        </p>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 rounded-full text-white font-bold transition-all duration-300 active:scale-95 bg-transparent border border-white/10 hover:bg-white/10 font-jetbrains"
        >
